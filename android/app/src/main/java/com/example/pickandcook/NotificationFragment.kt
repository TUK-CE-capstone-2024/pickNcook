package com.example.pickandcook.ui.notification
...
import com.example.pickandcook.NotificationAdapter
            ...
            .enqueue(object : Callback<List<Notification>> {
                override fun onResponse(call: Call<List<Notification>>, response: Response<List<Notification>>) {
                    if (response.isSuccessful) {
                        ...
                        adapter = NotificationAdapter(notifications.toMutableList()) { item ->
                            RetrofitClient.instance.deleteNotification(item.notificationNo).enqueue(object : Callback<Void> {
